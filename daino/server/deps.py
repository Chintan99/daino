...
_LANGUAGES = {
    ...
    ".toml": "toml", ".sh": "shell", ".bash": "shell", ".sql": "sql", ".go": "go",
    ".rs": "rust", ".java": "java", ".c": "c", ".h": "c", ".cpp": "cpp", ".rb": "ruby",
    ".php": "php", ".xml": "xml", ".txt": "plaintext", ".cfg": "ini", ".ini": "ini",
    ".dockerfile": "dockerfile", ".tsx.": "typescript",
}
