...
from daino.config.models import DeploymentTargetConfig, Settings
from daino.exceptions import DeploymentError, PolicyDenied
from daino.persistence import Database
from daino.persistence.models import DeploymentRun
from daino.runtimes import LocalRuntime, RemoteSSHRuntime, Runtime
from daino.schemas.core import DeploymentPlan, DeploymentRisk
...
class DeploymentManager:
    ...
    def _bundle(self, release_id: str) -> Path:
        output = paths.state_dir(self.root) / "artifacts" / "deployments" / f"{release_id}.tar.gz"
        ...
        with tarfile.open(output, "w:gz") as archive:
            for path in self.root.rglob("*"):
                ...
                if (
                    ...
                    and ".daino" not in relative.parts
