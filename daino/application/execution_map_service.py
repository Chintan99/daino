...
from daino.persistence.models import Mission, MissionEventRecord, ModelCall, ToolCall
...
class ExecutionMapApplicationService:
    ...
    view models. Tool nodes otherwise derive from Daino's bounded identifier,
